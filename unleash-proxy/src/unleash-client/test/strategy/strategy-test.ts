    ...
    const constraints = [
        {
            contextName: 'someVal',
            operator: 'DATE_AFTER',
            value: new Date('2022-01-28T14:00:00.000Z'),
        },
    ];
    const context = {
        environment: 'dev',
...
test('should be enabled when semver eq', (t) => {
    ...
    const params = {};
    const constraints = [
        { contextName: 'version', operator: 'SEMVER_EQ', value: '1.2.2' },
    ];
    const context = {
        environment: 'dev',
...
test('should be enabled when semver lt', (t) => {
    ...
    const params = {};
    const constraints = [
        { contextName: 'version', operator: 'SEMVER_LT', value: '1.2.2' },
    ];
    const context = {
        environment: 'dev',
...
test('should NOT be enabled for unknown field', (t) => {
    ...
    const params = {};
    const constraints = [
        { contextName: 'someField', operator: 'IN', values: ['s1'] },
    ];
    const context = {};
    // @ts-expect-error
    t.false(strategy.isEnabledWithConstraints(params, context, constraints));
...
test('should be enabled for undefined field when NOT_IN', (t) => {
    ...
    const params = {};
    const constraints = [
        { contextName: 'someField', operator: 'NOT_IN', values: ['s1'] },
    ];
